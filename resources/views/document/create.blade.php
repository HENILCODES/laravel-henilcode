    ...
    <div class="container my-3">
        ...
        <form class="row g-3 w-50 m-auto" action="{{ route('document.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="input-group">
                ...
                <input type="number" class="form-control" name="student_id" placeholder="Student name">
            </div>
            @error('student_id')
            ...
            <div class="input-group">
                ...
                <input class="form-control" list="DocumentTypes" name="type" placeholder="Enter document type">
